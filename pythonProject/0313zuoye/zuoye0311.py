...
@works_0311.get('/order')
def get_allorder():
    return orders

@works_0311.get('/order/{order_id}')
...
@works_0311.delete('/delete_order/{delete_order_id}')
