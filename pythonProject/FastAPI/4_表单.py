...
def create_user(order:Order):
    no = {"order_id": order.order_id, "order_price": order.order_price, "category": order.category,
...
if __name__ == '__main__':
    uvicorn.run("4_表单:app",host='127.0.0.1',port=8010)